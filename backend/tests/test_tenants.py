...
@pytest.mark.asyncio
async def test_create_tenant_centrum(client: AsyncClient):
    response = await client.post(
        "/api/v1/tenants/",
...
@pytest.mark.asyncio
async def test_list_tenants(client: AsyncClient, test_tenant):
...
@pytest.mark.asyncio
async def test_get_tenant(client: AsyncClient, test_tenant):
...
@pytest.mark.asyncio
async def test_tenant_not_found(client: AsyncClient):
    response = await client.get(f"/api/v1/tenants/{uuid.uuid4()}")
    assert response.status_code == 404


@pytest.mark.asyncio
async def test_update_tenant(client: AsyncClient, test_tenant):
...
@pytest.mark.asyncio
async def test_create_region(client: AsyncClient, test_tenant):
    response = await client.post(
...
@pytest.mark.asyncio
async def test_list_regions(client: AsyncClient, test_region):
    response = await client.get("/api/v1/tenants/regions/")
    assert response.status_code == 200
    assert isinstance(response.json(), list)


@pytest.mark.asyncio
async def test_create_user(client: AsyncClient, test_tenant):
    response = await client.post(
...
@pytest.mark.asyncio
async def test_list_users(client: AsyncClient, test_tenant, test_user):
...
@pytest.mark.asyncio
async def test_assign_tenant_role(client: AsyncClient, test_tenant, test_user):
    response = await client.post(
...
@pytest.mark.asyncio
async def test_assign_region_role(client: AsyncClient, test_region, test_user):
    response = await client.post(

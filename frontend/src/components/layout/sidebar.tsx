...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Organisatie', href: '/admin/organisatie', icon: BuildingOffice2Icon, minRole: 'admin' },
      { label: 'Custom velden', href: '/admin/velden', icon: RectangleStackIcon, minRole: 'admin' },

...
│  │  Knowledge: Leiden model, MAPGOOD, impact criteria       │   │
...
domain: isms
description: >
  Expert in risicobeheer volgens de Leiden "In Control" methode.
...
system_prompt: |
  ...
  ## Jouw expertise
  - Leiden "In Control" model (kwadranten: Mitigeren, Zekerheid, Monitoren, Accepteren)
...
set_attention_quadrant:
  description: Zet het Leiden kwadrant voor een risico
  category: write
  target_entity: Risk
  requires_confirmation: true
  risk_level: medium

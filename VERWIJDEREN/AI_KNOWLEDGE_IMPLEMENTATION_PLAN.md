...
| Bron | Methode | Verantwoordelijke |
|------|---------|-------------------|
| Leiden "In Control" documentatie | Handmatig invoeren | Domeinexpert |
| MAPGOOD standaard | Handmatig invoeren | Domeinexpert |
| Interne richtlijnen | Upload + AI extractie | Domeinexpert |

**Inhoud:**
- Leiden model uitleg (kwadranten, wanneer welke)
...
├── key (uniek, bijv. "METHODOLOGY_LEIDEN_QUADRANTS")
├── title ("De vier kwadranten van Leiden")
...
Help de gebruiker om risico's te classificeren volgens de Leiden methode.
Stel doorvragen om impact en kwetsbaarheid te bepalen.
Geef concrete suggesties die de gebruiker kan accepteren.

## METHODIEK KENNIS
### Leiden "In Control" Model
Het Leiden model bepaalt hoeveel aandacht een risico krijgt op basis van:
...
KEY                          | TITLE
─────────────────────────────┼──────────────────────────────
METHOD_LEIDEN_OVERVIEW       | Leiden "In Control" model
METHOD_LEIDEN_QUADRANTS      | De vier kwadranten
METHOD_LEIDEN_IMPACT         | Impact bepalen
METHOD_LEIDEN_VULNERABILITY  | Kwetsbaarheid bepalen
